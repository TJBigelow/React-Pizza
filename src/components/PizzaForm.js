  ...
  render() {
    return(
      <div className="form-row">
        <div className="col-5">
            <input type="text" onChange={this.handleToppingInput} className="form-control" placeholder="Pizza Topping" value={
                this.state.pizza.topping
              }/>
        </div>
        <div className="col">
          <select onChange={this.handleSizeInput} value={this.state.pizza.size} className="form-control">
